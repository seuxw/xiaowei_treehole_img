...
class ImgBlender():
    ...
    def __set_default_config__(self):
        # 文本换行设置
        self.contents['content_send'] = set_paragraph(self.contents['content_send'], 16)
        self.contents['content_reply'] = set_paragraph(self.contents['content_reply'], 16)
        ...
        # 文字位置配置
        self.posi_dict["title"] = (100,100)
        self.posi_dict["content_send"] = (100,270)
        self.posi_dict["sender"] = (950,700)
        self.posi_dict["date_send"] = (950,800)
        self.posi_dict["content_reply"] = (100,1000)
        self.posi_dict["replier"] = (950,1800)
        self.posi_dict["date_reply"] = (950,1900)

        # 文字颜色配置
        self.fill_dict["title"] = (0,0,0)
